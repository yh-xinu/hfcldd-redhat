...
#define HFC_MLPF_INDACC_XLOG    	0x07	/* FCLNX-GPL-FX-582,595 */
...
extern void hfc_fx_mlpf_migration_login_slpar( /* FCLNX-GPL-488 */
	struct port_info            *pp,
	unsigned int		hyp_status);

extern void hfc_fx_mlpf_remap_mig_fwif_addr( /* FCLNX-GPL-488 */
	struct port_info            *pp);

extern void hfc_fx_mlpf_unmap_mig_fwif_addr( /* FCLNX-GPL-488 */
	struct port_info            *pp);

extern void hfc_fx_mlpf_migration_login_glpar( /* FCLNX-GPL-488 */
	struct port_info            *pp,
	unsigned int		hyp_status);

extern int hfc_fx_mlpf_get_luid_info( /* FCLNX-GPL-488 */
	struct port_info *pp);

extern int hfc_fx_mlpf_issue_inquiry( /* FCLNX-GPL-488 */
			uchar				*sense_data,
			ushort				*resid,
			struct port_info	*pp,
			uint64_t			ww_name,
...
extern int hfc_fx_mlpf_issue_rluns( /* FCLNX-GPL-488 */
			uchar				*sense_data,
			ushort				*resid,
			struct port_info	*pp,
			uint64_t			ww_name,
...
extern int hfc_fx_mlpf_issue_sccmnd( /* FCLNX-GPL-488 */
			struct port_info *pp,
			void *arg,
			int timeout);

extern void hfc_fx_mlpf_mig_iodone( /* FCLNX-GPL-488 */
			struct scsi_cmnd *cmnd );

extern void hfc_fx_mlpf_check_inquiry_resp( /* FCLNX-GPL-488 */
			struct port_info *pp);

extern void hfc_fx_mlpf_migration_login_complete( /* FCLNX-GPL-488 */
			struct port_info *pp,
			unsigned short result,
			unsigned int detail);

extern void hfc_fx_mlpf_check_mig_cmnd_complete( /* FCLNX-GPL-488 */
			struct port_info *pp);

extern int hfc_fx_mlpf_aloc_devinfo( /* FCLNX-GPL-488 */
			uchar					*inq_83,
			uchar					*sense_data,
			struct port_info	 	*pp,
...
extern int hfc_fx_mlpf_set_luid( /* FCLNX-GPL-488 */
			uchar					*inq_83,
			uchar					*sense_data,
			struct port_info	 	*pp,
...
extern void hfc_fx_mlpf_migration_login_complate( /* FCLNX-GPL-488 */
	struct port_info *pp,
	unsigned int result,
	unsigned int detail);
...
/* FCLNX-GPL-FX-488 >>> */
extern int hfc_fx_mlpf_alloc_target_list(
	struct port_info	*pp);

extern void hfc_fx_mlpf_free_target_list(
	struct port_info	*pp);

extern void hfc_fx_mlpf_setup_target_list(
	struct port_info	*pp);

extern void hfc_fx_mlpf_setup_target_listinfo(
	struct port_info	*pp,
	uint				tid);

extern void hfc_fx_mlpf_clear_target_listinfo(
	struct port_info	*pp, 
	uint				tid);

extern int hfc_fx_mlpf_alloc_luid_list(
	struct port_info	*pp,
	uint				tid,
	ushort				lunum);

extern void hfc_fx_mlpf_free_luid_list(
	struct port_info	*pp,
	uint				tid);

extern void hfc_fx_mlpf_setup_luid_info(
	struct port_info	*pp,
	uint				tid,
	ushort				luno,
	ushort				type,
...
extern void hfc_fx_mlpf_clear_luid_info(
	struct port_info	*pp,
	uint				tid,
	ushort				luno);

extern int hfc_fx_mlpf_alloc_fwifaddr_list(
	struct port_info *pp);

extern void hfc_fx_mlpf_free_fwifaddr_list(
	struct port_info *pp);

void hfc_fx_mlpf_setup_fwifaddr_list(
	struct port_info *pp);
