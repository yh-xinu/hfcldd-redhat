...
extern int hfc_fx_xrb_resp_shadow(struct port_info *pp, struct region_info *rp, struct core_info *core, uint64_t time, uint cpuno, struct hfc_pkt_fx *(*wait_iodone_hfcp));	/* FCLNX-GPL-FX-488 */
