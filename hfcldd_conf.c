...
static uint8_t hfc_nonpub_symbol_list[sizeof(struct nonpub_symbol_list)]; /* FCLNX-GPL-FX-726 */
static uint8_t hfc_pub_symbol_list[sizeof(struct pub_symbol_list)]; /* FCLNX-GPL-FX-726 */
 ...
 * Notes:       
 */
void *hfc_get_nonpub_symbol_list(void) /* FCLNX-GPL-FX-726 */
{
	return (&hfc_nonpub_symbol_list); /* FCLNX-GPL-FX-726 */
}
 ...
 * Notes:       
 */
void *hfc_get_pub_symbol_list(void) /* FCLNX-GPL-FX-726 */
{
	return (&hfc_pub_symbol_list); /* FCLNX-GPL-FX-726 */
}
