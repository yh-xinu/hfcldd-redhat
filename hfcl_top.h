...
/* FCLNX-GPL-FX-689 */
#ifdef HFC_RHEL7
extern struct Scsi_Host *hfc_scsi_host_alloc_new(struct scsi_host_template_new *sht, int privsize);	/* FCLNX-GPL-FX-683 */
#endif
...
extern void hfc_modify_request_timer(struct scsi_cmnd *cmnd); /* FCLNX-GPL-FX-704 */
...
#define HFC_MAX_SLEEP (120 * HZ) /* 120sec */
