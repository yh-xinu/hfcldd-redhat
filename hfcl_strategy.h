...
extern int hfc_strategy(struct Scsi_Host *shost, struct scsi_cmnd *cmd);/* FCLNX-GPL-FX-547 */
extern int hfc_strategy_ext(struct scsi_cmnd *cmnd, void (*iodone)(struct scsi_cmnd *)); /* FCLNX-GPL-FX-547 */
#else
