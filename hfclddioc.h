...
/* FCLNX-GPL-FX-577,595 >>> */
/*-------------------------------------------------------*/
/* errlog format for HVM shared mode. offset 0x180-0x1BF */
/*-------------------------------------------------------*/
typedef struct {
	uint                hyper_status;                        /* +00 */
	uint                hyper_int_detail;                    /* +04 */
} mmiohg_core_info;

typedef struct {
	uint                hyper_status;                        /* +00 */
	uint                command_register;                    /* +04 */
	uint                lpar_status;                         /* +08 */
	uint                hyper_int_detail;                    /* +0C */
	uchar               rsv[16];                             /* +10 */
} mmiohg_info_ex;
...
typedef struct {
	...
	uint                lpar_status;                         /* +08 */
	uint                hyper_int_detail;                    /* +0C */
	uchar               request_flag;                        /* +10 */
	uchar               target_count;                        /* +11 */
	ushort              count_to_update_table;               /* +12 */
	uint                port_status_of_source_for_shadow;    /* +14 */
	ushort              result_factor;                       /* +18 */
	uchar               detail_code[6];                      /* +1A */
	mmiohg_core_info    core[4];                             /* +20 */
} mmiohg_info_fx;
/* >>>FCLNX-GPL-FX-577  */
