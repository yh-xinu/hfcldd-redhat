...
extern struct hfc_pm_pkt_fx *hfc_fx_get_new_pm_hfcp(struct port_info *pp, uint pm_pkt_no); /* FCLNX-GPL-FX-547 */
extern int hfc_fx_strategy_port(struct hfc_pkt_fx *hfcp, int *func_rc); /* FCLNX-GPL-FX-266 */ /* FCLNX-GPL-FX-547 */ /* FCLNX-GPL-FX-593 *//* FCLNX-GPL-FX-645 */
...
extern struct core_info *hfc_fx_choose_core(struct port_info *pp, struct hfc_pkt_fx *hfcp); /* FCLNX-GPL-FX-645 */
...
extern void hfc_fx_clear_tgt_core_stat(
	struct port_info			*pp,
	struct target_info_fx		*target);

extern int hfc_fx_test_tgt_core_stat(
	struct port_info			*pp,
	struct target_info_fx		*target);
...
extern int hfc_set_new_hfcp(struct port_info *pp, struct hfc_pkt_fx *new_hfcp); /* FCLNX-GPL-FX-547 */
