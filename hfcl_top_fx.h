...
extern uint hfc_fx_check_seq_num( struct port_info *pp, int num );	/* FCLNX-GPL-FX-647 */
...
#ifdef HFC_RHEL7
/* FCLNX-GPL-FX-683 */
extern struct Scsi_Host *hfc_fx_scsi_host_alloc_new(struct scsi_host_template_new *sht, int privsize);
#endif
...
extern void hfc_fx_mq_all_cancel_scsi(struct port_info *pp, struct target_info_fx *target, struct dev_info_fx *dev, struct hfc_pkt_fx *hfcp, uchar cancel_nexus,uchar cancel_ctl);
