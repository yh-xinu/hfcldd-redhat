...
typedef unsigned long long atomic64_t ; /* FCLNX-GPL-FX-547 */
...
#define HFC_DEFAULT_LUN			0x800	/* FCLNX-GPL-FX-684 */
...
#define REPORTLUNS_DATA_LEN		16392								/* 2048*8 + 8 = 16392 *//* FCLNX-GPL-FX 488 */
#define INQ_83_LEN				256
...
#define HFC_DEVLOSS_PENDING		9			/* The fc_remote_port_delete was done */ /* FCLNX-GPL-FX-522 */
...
#define HFC_WRITE_PROCESS		6				/* write process is in progress				*/
	...
	struct scsi_host_template_new	*hfcldd_driver_template_mp_rhel75;
	struct scsi_host_template_new	*hfcldd_driver_template_platform_bus_rhel75;
#endif
...
/* FCLNX-GPL-FX-689 */
#ifdef HFC_RHEL7
	int (*hfc_mp_scsi_host_alloc_new) (struct scsi_host_template_new *temp, 
					struct Scsi_Host *shost, struct adap_info *ap, struct Scsi_Host **hsd_host, struct Scsi_Host **pfb_host);
#endif
...
/* FCLNX-GPL-FX-689 */
#ifdef HFC_RHEL7
	int (*hfc_fx_mp_scsi_host_alloc_new) (struct scsi_host_template_new *temp, 
					struct Scsi_Host *shost, struct port_info *pp, struct Scsi_Host **hsd_host, struct Scsi_Host **pfb_host);
#endif
...
struct pub_symbol_list {
	...
	void (*hfc_watchdog) (struct timer_list *timer);
#else
	...
	int (*hfc_fx_strategy_port) (struct hfc_pkt_fx *hfcp, int *func_rc); /* FCLNX-GPL-FX-266 */ /* FCLNX-GPL-FX-547 */ /* FCLNX-GPL-FX-593 *//* FCLNX-GPL-FX-645 */
	...
	struct core_info *(*hfc_fx_choose_core) (struct port_info *pp, struct hfc_pkt_fx *hfcp); /* FCLNX-GPL-FX-645 */
	...
	int (* hfc_map_queues)(struct Scsi_Host *shost);
