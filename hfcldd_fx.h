...
/************************************************************************/
/* RHEL Driver Update Program                                           */
/************************************************************************/
/* FCLNX-GPL-FX-609 */
#if defined(HFC_RHEL7_SCSI_MQ)
struct hfc_blk_mq_ctx {
	struct {
		spinlock_t              lock;
...
#define HFC_ALLCORELOCK_MQ(_PP) {												\
		if ((_PP)) {															\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[0])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[1])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[2])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[3])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[4])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[5])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[6])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[7])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[8])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[9])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[10])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[11])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[12])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[13])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[14])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[15])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[16])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[17])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[18])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[19])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[20])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[21])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[22])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[23])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[24])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[25])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[26])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[27])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[28])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[29])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[30])					\
				HFC_ALLCORELOCK((_PP)->pport->region_arg[31])					\
		}																		\
}

#define HFC_ALLCOREUNLOCK_MQ(_PP) {												\
		if ((_PP)) {															\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[31])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[30])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[29])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[28])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[27])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[26])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[25])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[24])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[23])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[22])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[21])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[20])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[19])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[18])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[17])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[16])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[15])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[14])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[13])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[12])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[11])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[10])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[9])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[8])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[7])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[6])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[5])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[4])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[3])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[2])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[1])					\
				HFC_ALLCOREUNLOCK((_PP)->pport->region_arg[0])					\
		}																		\
}

#define HFC_ALLLOCK_MQ_IRQSAVE(_PP, _FLAGS) {									\
		if ((_PP)) {															\
				HFC_PORTLOCK_IRQSAVE((_PP), (_FLAGS))							\
																				\
				HFC_ALLCORELOCK_MQ((_PP))										\
		}																		\
}

#define HFC_ALLUNLOCK_MQ_IRQRESTORE(_PP, _FLAGS) {								\
		if ((_PP)) {															\
				HFC_ALLCOREUNLOCK_MQ((_PP))										\
																				\
				HFC_PORTUNLOCK_IRQRESTORE((_PP), (_FLAGS))						\
		}																		\
}
...
#define HFC_FX_MIG_SCCMND_TO		0		/* issue a scsi command for Migration *//* FCLNX-GPL-FX-488 */
/**************************************************************************************************/
/* structure																					  */
/**************************************************************************************************/
/************************************************************************/
...
/* FCLNX-GPL-FX-488 concurrent maintenance */
#define HFC_FX_MIG_SCCMND_TMR		54		/* Issue SCSI Command Timer for Migration */
...
//	struct payload_fx		*payload;		/* Payload Virtual Address for FRMSNDRCV	*/
	...
	/* FCLNX-GPL-FX-488 */
	struct fw_init_tbl_fx	*mig_fw_init_p;	/* INIT_TBL	for Migration					*/
	struct mailbox_fx		*mig_mb;		/* MAILBOX	for Migration					*/
	/* FCLNX-GPL-FX-488 */
...
#define HFC_PD_MLPF_MIG_LOGINPROC	30			/* excuting Login process for LiveMig       *//* FCLNX-GPL-FX-488 */
//@MLPF
...
//#define HFC_DIAG_OPENED		2
	...
	uchar					fcp_mode ;		/* Diag used
		*/
	uchar 					lpar_support;		/*	FW LPAR support 	*/	/* FCLNX-GPL-FX-556 */
...
//	atomic64_t			pkt_next;		/* Next pointer for hfc_pkt pool				*/ 
...
//	struct scsi_cmnd		*cmnd_pool;		/* Scsi_Cmnd Pointer for Task Management		*/
	...
	/* FCLNX-GPL-FX-488 >>> */
	struct scsi_cmnd		*mig_cmnd;		/* Scsi_Cmnd Pointer for mig					*/
	struct dev_info_fx		*mig_dev;		/* Dev_info Pointer for mig						*/
	char					*mig_sense;		/* sense data Pointer for mig					*/
	struct xob_fx			*mig_xob_p;		/* XOB Pointer for mig							*/
	struct xrb_fx			*mig_xrb_p;		/* XRB Pointer for mig							*/
	char					*mig_slog[64];	/* SOFT LOG Pointer for mig						*/
	char					*mig_seg_svaddr[5];	/* seg_info Pointer for mig	*/ /* FCLNX-GPL-FX-533 */
	dma_addr_t				mig_seg_spaddr[5];	/* seg_info Pointer for mig						*/
	uint64_t				mig_seg_gpaddr[5];	/* seg_info Pointer for mig	*/ /* FCLNX-GPL-FX-533 */
	struct rcvfrm_payload_fx	*mig_rcvpayload_vsaddr;	/* Receive Frame Payload Pointer of Shadow	*/
	dma_addr_t				mig_rcvpayload_psaddr;	/* Receive Frame Payload Pointer of Guest	*/
	uint64_t				mig_rcvpayload_gpaddr;	/* Receive Frame Payload Pointer of Guest	*/
	struct	payload_fx		*mig_payload_vsaddr;	/* Receive Frame Payload Pointer of Shadow	*/
	dma_addr_t				mig_payload_psaddr;	/* Receive Frame Payload Pointer of Guest	*/
	uint64_t				mig_payload_gpaddr;	/* Receive Frame Payload Pointer of Guest	*/
	uint64_t				mig_wwpn;		/* WWPN for mig									*/
	uint64_t				mig_scsi_id; 	/* HBA SCSI-id for scsi_id						*/
	/* >>> FCLNX-GPL-FX-488 */
...
#define HFC_FX_HWLOG_SIZE   0x20000			/* 128KB				 						*/
	...
	uint					cscsi_mb_num;		/* FCLNX-GPL-FX-556 */
...
//	struct target_info_fx		*prli_target;	/* Target is in LOGIN wait state				*/
	...
	uchar					mig_req_flag;
	uchar					mig_rid;
	ushort					mig_login_delay;
	uint					mig_master_core_no; /* The number of Master Core					*/
	uint					mig_available_core;
#define HFC_MIG_XOB_MAX		8
	/* >>> FCLNX-GPL-FX-488 */
	struct hfc_mig_expire_log	mig_exp_log; /*the drvlog of migration failure *//* FCLNX-GPL-FX-583,595 */
...
//	atomic_t				curr_core;		/* Just used core num counter 
//											   to choose next core	*/ 
...
#define HFC_MAX_TRCCNT  256					/* Max trace count	 							*/
	...
	struct hg_mig_tgtlist	*mig_tgtlist;	/* FCLNX-GPL-FX-488*/
	struct mig_fwifaddr_list	*mig_fwalist;	/* FCLNX-GPL-FX-488*/
...
/* FCLNX-GPL-FX-582,595 >>>*/
	uchar					*mlpf_xlog; 
	uchar					hvm_extended_log;
#define HFC_HVM_EXTENDED_LOG_ENABLE			1
#define HFC_HVM_EXTENDED_LOG_DISABLE			0
	uchar					mlpf_xlog_flag; 
/* >>> FCLNX-GPL-FX-582 */
...
/* FCLNX-GPL-488 >>> */
	uchar					hg_migration_enable;
#define HFC_FX_ENABLE_MIGRATION			1
#define HFC_FX_DISABLE_MIGRATION		0
/* >>> FCLNX-GPL-488 */
...
#define HFC_FX_MAX_LOGIN_SEQ_RETRY_CNT		10			/* FCLNX-GPL-FX-446 <<< */
	...
	uchar					log_after_receive_frame;	/* FCLNX-GPL-FX-603 */
#define HFC_FX_LINKUP_LOG			1
#define HFC_FX_RECEIVE_FLOGI_LOG	2
...
//	wait_queue_head_t   	mb_lock_event;	/* waitqueue until the lock bit would get	*/
	...
	atomic64_t                              pkt_next;       /* Next pointer for hfc_pkt pool */ /* FCLNX-GPL-FX-547 */
	atomic_t                                curr_core;      /* Just used core num counter to choose next core  */ /* FCLNX-GPL-FX-547*/
	atomic_t				int_a_poll;		/* interrupt polling						*/
	atomic_t				mb_event_wait;
	atomic_t				ioctl_event_wait;
	atomic_t				mck_event_wait;
	...
	dma_addr_t				phys_rcvfrm_payload;	/* Receive Frame Payload Address	*/
	dma_addr_t				phys_payload;	/* Payload DMA Address for FRMSNDRCV		*/
	dma_addr_t				padr_mig_tgtlist;	/* psycal address of uncached memory area shared Hypervisor *//* FCLNX-GPL-FX-488*/
	dma_addr_t				padr_mig_fwalist;	/* psycal address of uncached memory area shared Hypervisor *//* FCLNX-GPL-FX-488*/
...
//	struct wtimer_fx		mpap_lock_wdog;	/* mp_adap_info lock wait					*//* FIVE-FX */
	...
	struct wtimer_fx		mig_sccmnd_wdog;	/* Issue a scsi command for Migration *//* FCLNX-GPL-FX-488 */
...
#define	HFC_DS_NEED_MIG_INQUIRY				13		/* Need to issue INQUIRY 			*//* FCLNX-GPL-FX-488 */
#define	HFC_DS_WAIT_MIG_INQUIRY				14		/* INQUIRY is in progress			*//* FCLNX-GPL-FX-488 */
...
#define HFC_DS_BLOCKED_SCSI 					\
	...
	~((0x00000001 << HFC_DS_FAIL_ABORT)		|	\
	  ...
	  (0x00000001 << HFC_DS_NEED_MIG_INQUIRY)|	\
	  (0x00000001 << HFC_DS_WAIT_MIG_INQUIRY)))
/* FCLNX-GPL-FX-014 */
...
/* FCLNX-GPL-FX-014 Start */
	union{
		uint	all[HFC_FX_MAX_MQ_NUM]; /* FCLNX-GPL-FX-556 */
		uchar	core[HFC_FX_MAX_MQ_NUM][MAX_CORE_PROBE_FX]; /* FCLNX-GPL-FX-556 */
...
#define DEVINFO_COMP_LEN		128								/* FCLNX-0315 */
	...
	ushort					luid_list_no;	/* FCLNX-GPL-FX-494 */
...
#define HFC_INQ83_IDTYPE3	3	/* FCLNX-710 */
	char					mig_scsi_retry;	/* reitry count of scsi command for migration	*//* FCLNX-GPL-FX-488 */
#define HFC_FX_MAX_RETRY_MIG_SCCMND	3	/* FCLNX-GPL-FX-488 */
...
#define	HFC_TS_NEED_RLUNS_MIG	20			/* Need to issue REPORT LUNS for MIg	*/
#define	HFC_TS_WAIT_RLUNS_MIG	21			/* REPORT LUNS is in progress			*/
#define HFC_TS_WAIT_TARGET_STOP         22              /* SCN Linkup timer was timeout */ /* FCLNX-GPL-FX-554 */

#define HFC_TS_BLOCKED_SCSI 						\
	(0xffffffff &									\
	~((0x00000001 << HFC_TS_NEED_TARGET_RESET) |	\
	  (0x00000001 << HFC_TS_WAIT_TGTRSP)	   |	\
	  (0x00000001 << HFC_TS_NEED_RLUNS_MIG)	   |	\
	  (0x00000001 << HFC_TS_WAIT_RLUNS_MIG)) )
...
#define HFC_TF_DEVLOSS_PENDING		6		/* The fc_remote_port_delete was done */ /* FCLNX-GPL-FX-523 */
...
#define	HFC_PKT_TYPE_TARGET_RESET			0
#define	HFC_PKT_TYPE_WITHOUT_DMA			1
#define	HFC_PKT_TYPE_WAIT_DMA				2
...
#define HFC_NEED_RPORT_DEL      1 /* FCLNX-GPL206 */
	...
	struct mig_luid_info	*mig_luid_info;	/* FCLNX-GPL-FX-488*/
	dma_addr_t				padr_mig_luid_info;	/* psycal address of uncached memory area shared Hypervisor *//* FCLNX-GPL-FX-488*/
	uint					mig_lidlist_size;
	char					mig_scsi_retry;	/* reitry count of scsi command for migration	*//* FCLNX-GPL-FX-495 */
};
